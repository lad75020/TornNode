module.exports = async function wsUpdatePrice(socket, req, client, fastify, parsed, redisClient, opts = {}) {
  ...
  try { const { lastMinPrices } = require('./priceState'); lastMinPrices.set(idInt, price); } catch(_){ }
        const now = new Date();
