            ...
            socket.on('message', async (raw, isBinary) => {
                ...
                switch (message) {
                    ...
                    case 'checkSession':
                        ...
                        require('../ws/wsCheckSession.cjs')( socket, req);
                        return;
                    case 'networth':
                        fastify.log.info({ connId }, '[ws] networth command');
                        require('../ws/wsInsertNetworth.cjs')( req, fastify, socket);
                        return;
                    case 'stats':
                        fastify.log.info({ connId }, '[ws] stats command');
                        try { require('../ws/wsCompanyStock.cjs')(socket, req, fastify); } catch(e){ fastify.log.error(e); }
                        try { require('../ws/wsStats.cjs')(socket, req, fastify); } catch(e){ fastify.log.error(e); }
                        try { require('../ws/wsCompanyProfile.cjs')(socket, req, fastify); } catch(e){ fastify.log.error(e); }
                        try { require('../ws/wsCompanyDetails.cjs')(socket, req, fastify); } catch(e){ fastify.log.error(e); }
                        return;
                    case 'destroySession':
                    ...
                    case 'deduplicate':
                        ...
                        require('../ws/wsDeduplicate')(fastify, socket);
                        return;
                    case 'racingskill': {
                        fastify.log.info({ connId }, '[ws] racingskill command');
                        try { require('../ws/wsRacingSkill.cjs')(socket, req, fastify); } catch(e){ fastify.log.error(e); }
                        return;
                    }
                    case 'lastNetworth': {
                        fastify.log.info({ connId }, '[ws] lastNetworth command');
                        try {
                            require('../ws/wsLastNetworthStats.cjs')(socket, req, fastify);
                        } catch(e) {
                    ...
                    case 'getNetworth': {
                        ...
                        try { require('../ws/wsGetNetworth.cjs')(socket, req, fastify); } catch(e){
                    ...
                    case 'dailyPriceAveragesAll': {
                        ...
                        try { require('../ws/wsDailyPriceAverages.cjs')(socket, req, fastify); } catch(e){
